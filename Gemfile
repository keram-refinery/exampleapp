...
gem 'rails', '~> 4.0.0'#, :path => 'vendor/rails'
...
# gem 'refinerycms-i18n', :path => 'vendor/'
gem 'refinerycms-i18n', :git => 'https://github.com/keram-refinery/refinerycms-i18n.git', :branch => 'refinery_light'
